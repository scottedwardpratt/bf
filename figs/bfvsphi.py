...
filename_type1='bfdata/type1/bf_phi.txt'
filename_type2='bfdata/type2/bf_noregeneration_phi.txt'
filename_type3='bfdata/type2/bf_withregeneration_phi.txt'
...
legend(loc=(0.32,0.8),fontsize=18)

ax.set_xticks(np.arange(0,200,30), minor=False)
ax.set_xticks(np.arange(0,200,10), minor=True)
ax.set_xticklabels(np.arange(0,200,30),minor=False,size=18, family='serif')
...
plt.xlabel('$\\Delta \\phi$ [degrees]',fontsize=24, family='serif',labelpad=0)
plt.ylabel('$B(\\Delta \\phi)$ [rad$^{-1}]$',fontsize=24,family='serif',labelpad=0)
    
ax.xaxis.set_major_formatter(sformatter)
ax.yaxis.set_major_formatter(sformatter)

text(175,0.33,'(b)',fontsize=22,ha='right')

filename='bfvsphi.pdf'
