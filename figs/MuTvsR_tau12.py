...
plt.plot(rK,1000*TK,linestyle='-',color='g',markersize=6,marker='s',markerfacecolor='g')
plt.plot(rB,1000*TB,linestyle='-',color='b',markersize=6,marker='^',markerfacecolor='b')
...
text(25,27.0,"(d)",fontsize=20,ha='right')
...
plt.plot(rK,rhoK,linestyle='-',color='g',markersize=6,marker='s',markerfacecolor='g',label='$K$')
plt.plot(rB,rhoB,linestyle='-',color='b',markersize=6,marker='^',markerfacecolor='b',label='$N$')
...
ax.set_yticklabels(np.arange(0,4,0.5), minor=False, family='sans',fontsize=16)
...
text(25,0.1,"(c)",fontsize=20,ha='right')
...
text(25,0.1,"(b)",fontsize=20,ha='right')
...
plt.plot(x,yK,linestyle='-',color='g',markersize=6,marker='s',markerfacecolor='g')
...
plt.plot(x,yB,linestyle='-',color='b',markersize=6,marker='^',markerfacecolor='b')
...
plt.plot(x,DelY,linestyle='-',color='k',markersize=6,marker='*',markerfacecolor='k')
...
ax.set_yticklabels(np.arange(-5.0,20.0,5.0), minor=False, family='sans',fontsize=16)
...
text(0.5,8.5,"$\\tau=$"+str(tau)+" fm/$c$",fontsize=22)
text(0.0,10.5,"$\\star~2\\mu_N/T_N-5\\mu_\\pi/T_\\pi$",fontsize=18)
text(25,-1.0,"(a)",fontsize=20,ha='right')
