...
filename='data/muTvsR_B0_tau'+str(tau)+'.txt'
...
rhoB0=tau*B0data[5]
UB0_alt=B0data[7]
filename='data/muTvsR_B1_tau'+str(tau)+'.txt'
...
rhoB1=tau*B1data[5]
UB1_alt=B1data[7]
filename='data/muTvsR_B2_tau'+str(tau)+'.txt'
...
rhoB2=tau*B2data[5]
UB2_alt=B2data[7]
filename='data/muTvsR_B3_tau'+str(tau)+'.txt'
...
text(25,26.0,"(h)",fontsize=20,ha='right')

#######################################

ax = fig.add_axes([0.19,0.29,0.8,0.23])

plt.plot(rB0,rhoB0,linestyle='-',color='r',markersize=6,marker='o',markerfacecolor='r',label='$N$')
...
plt.plot(rB3,rhoB3,linestyle='-',color='k',markersize=6,marker='v',markerfacecolor='k',label='$\\Lambda$')

legend(loc=(0.72,0.35),fontsize=18)
...
text(25,0.01,"(g)",fontsize=20,ha='right')
...
text(25,0.2,"(f)",fontsize=20,ha='right')
...
text(25,-1.0,"(e)",fontsize=20,ha='right')

#######################################

filename='MuTvsR_tau'+str(tau)+"_baryon.pdf"
