...
ymin=-0.2
ymax=0.1
#plt.plot(xx1,bbff_noregeneration,linestyle='-',linewidth=3,color='r',markersize=6, marker='o',markerfacecolor='r',label='No annihilations')
...
plt.plot(xx2,bbff_noregeneration,linestyle='-',linewidth=3,color='g',markersize=6, marker='o',markerfacecolor='g',label='with annihilations')

plt.plot(xx2,bbff_withregeneration,linestyle='-',linewidth=3,color='k',markersize=6, marker='o',markerfacecolor='k',label='with regeneration')
...
plt.ylabel('$B(q_{\\rm inv})$',fontsize=24,family='serif',labelpad=-3)
